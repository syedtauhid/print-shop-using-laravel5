        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a  ><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"> Upload Info</span></a></li>
                    ...
                    <div role="tabpanel" class="tab-pane active">
                                                    ...
                                                    @foreach($data as $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-nowrap">
                                                                ...
                                                                <a class="btn btn-danger btn-circle" href="{{route('admin.category.upload-info.delete',$item->id)}}" data-toggle="tooltip" data-original-title="delete">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 well">
                                <form class="" method="post" action="{{route('admin.category.upload-info',[$id])}}">
                                    {!! Form::token() !!}
                                    <div class="col-md-3">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click','.edit-button',function () {
            ...
            var url = '{!! route('admin.category.upload-info.update',[':categoryId',':uploadInfoId']) !!}';
